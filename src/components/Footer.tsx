      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm font-urbanist text-primary-foreground/80">
              International Ski-Mountaineering Federation (ISMF) World Cup Competition
            </p>
          </div>
          
          <div>
            <h4 className="font-urbanist font-semibold mb-4">Quick Links</h4>
            <ul className="space-y-2 text-sm font-urbanist text-primary-foreground/80">
          ...
          <div>
            <h4 className="font-urbanist font-semibold mb-4">Contact</h4>
            <ul className="space-y-2 text-sm font-urbanist text-primary-foreground/80">
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center">
          <p className="text-sm font-urbanist text-primary-foreground/60">
