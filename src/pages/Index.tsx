...
const Index = () => {
  ...
  const faqs = [
      ...
      answer: (
        <>
          ...
          <p className="mb-4">
            ...
            EUR) within 3 days in just three simple steps: application, payment,
            and download. Urgent visas can be processed in as little as 3 hours
            for a fee of 60 USD (55.15 EUR). You can apply for an e-visa through
            the following link:{" "}
            <a
    ...
    },
    {
      ...
      answer: (
        <>
          <p className="mb-2">
            If you have any questions about the race, feel free to reach out to
            us at{" "}
            <a
          ...
          <p>
            If you have any questions about the accommodation, you can always
            contact us at{" "}
            <a
              href="mailto:reservations@shahdag.az"
              className="text-primary hover:underline font-medium"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        id="gear"
        className="py-12 md:py-20 px-4 bg-muted/30 scroll-mt-20"
      >
        <div className="container mx-auto max-w-6xl">
